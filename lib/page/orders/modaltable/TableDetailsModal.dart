      ...
      return Container(
        ...
        child: Column(
          children: [
                      ...
                      if (!enEdicion) ...[
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            // Cantidad clickeable para editar
                            GestureDetector(
                              onTap: () =>
            ...
            // ✅ NUEVO: Panel de edición inline (se muestra debajo cuando está en edición)
            if (enEdicion &&
              ...
              Container(
                ...
                child: Row(
                  children: [
                    // Switch entre aumentar/disminuir
                    GestureDetector(
