...
if (tableController.pedidos.length > 1 && !tableController.esGrupo)
  _buildOrderSelector(tableController),
                // Lista de productos
                Expanded(
                  child: Obx(
                    () => tableController.selectedOrderIndex.value == -1
          ...
          children: [
            ...
            Expanded(
              child: GestureDetector(
                onTap: () {
                  final pedidoActual = controller.selectedOrderIndex.value >= 0
                ...
                child: Row(
                  ...
                  children: [
                    Flexible(
                      child: Text(
                        controller.selectedOrderIndex.value >= 0
                            ? (controller.pedidos[controller.selectedOrderIndex.value]['nombreOrden'] ?? 'Sin nombre')
                            : controller.pedidos.isNotEmpty
                                ? (controller.pedidos[0]['nombreOrden'] ?? 'Sin nombre')
                                : 'Sin nombre',
                        style: TextStyle(
                          fontSize: 20,
                    ...
                    SizedBox(width: 6),
                    Icon(Icons.edit, size: 16, color: Color(0xFF8B4513).withOpacity(0.7)),
                  ],
                ),
              ),
            ),
...
Obx(() {
  final updating = controller.isUpdating.value; // ✅ observable dentro del Obx
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    margin: EdgeInsets.only(
                      right: index < controller.pedidos.length - 1 ? 8 : 0,
                    ),
                    decoration: BoxDecoration(
      ...
      child: Column(
        children: [
                    ...
                    if (!enEdicion) ...[
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () => controller.activarEdicionCantidad(detalleId),
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  SizedBox(width: 4),
                                  Icon(Icons.edit, size: 12, color: Color(0xFF8B4513)),
                                ],
                              ),
                            ),
                          ),
          ...
          if (enEdicion &&
            ...
            Text(
              'cant $cantidad',
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12, color: Color(0xFF3E1F08)),
            ),
            SizedBox(height: 12),
            Container(
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Obx(() => Container(
                      ...
                      child: Icon(
                        controller.modoEdicion.value == 'aumentar' ? Icons.add : Icons.remove,
                        color: controller.modoEdicion.value == 'aumentar'
                            ? Color(0xFF27AE60)
                            : Color(0xFFE74C3C),
                        size: 20,
                  ...
                  Expanded(
                    child: TextFormField(
                      ...
                      onChanged: (value) => controller.cantidadEdicion.value = value,
                    ),
                  ),
                  SizedBox(width: 8),
                  Row(
                    children: [
                      ...
                      SizedBox(width: 4),
                      GestureDetector(
                        onTap: () => controller.confirmarCambioManual(producto),
                        child: Container(
                          padding: EdgeInsets.all(8),
                          decoration: BoxDecoration(
      ...
      child: Column(
        children: [
          ...
          Obx(() {
            ...
            final haySeleccionados =
                controller.productosSeleccionados.isNotEmpty;
          ...
          Obx(() {
            if (controller.selectedOrderIndex.value == -1) {
              ...
              return Obx(() {
                ...
                final productosSeleccionados = controller
                    .getProductosSeleccionadosDelPedidoActual();
                final totalSeleccionados = controller
                    .calcularTotalProductosSeleccionadosDelPedido();

                // ✅ AGREGAR: Variable para controlar el estado de carga
                final isProcessingPayment = controller
                    .isUpdating
                    .value; // O crear una nueva variable específica

                if (tipoBoton == 'ninguno') {
                  // Si no hay productos seleccionados, mostrar botón tradicional
                  if (controller.puedeSerPagado(pedido)) {
                    final esUltimoPendiente = controller
                        .esUltimoPedidoPendiente(pedido);
                    ...
                    return SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        onPressed: isProcessingPayment
                            ? null
                            : (esUltimoPendiente
                                  ? () => controller.confirmarPagoYLiberacion(
                                      pedido,
                                    )
                                  : () =>
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          onPressed: isProcessingPayment
                              ? null
                              : () => controller
                                    .confirmarPagoProductosSeleccionados(),
                          ...
                          // ✅ MODIFICAR: Cambiar texto mientras carga
                          label: Text(
                            isProcessingPayment ? 'PROCESANDO...' : textoBoton,
                            style: TextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.bold,
                              color: Colors.white,
