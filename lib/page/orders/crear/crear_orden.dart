            ...
            child: Obx(() {
              ...
              mesasOrdenadas.sort((a, b) {
                try {
                  ...
                  return a.numeroMesa.toString().compareTo(
                    b.numeroMesa.toString(),
                  );
                }
              });
              ...
              return Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<Mesa?>(
                    ...
                    isExpanded: true,
                    // ✅ Recargar mesas antes de mostrar la lista
                    onTap: () {
                      controller.refrescarMesasSilencioso();
                    },
                    items: mesasOrdenadas
                        .map(
                          (mesa) => DropdownMenuItem<Mesa?>(
                            value: mesa,
                            child: Text(
                              mesa.displayName,
                              overflow: TextOverflow.ellipsis,
                        ...
                        .toList(),
                    onChanged: (mesa) {
                      if (mesa != null) controller.seleccionarMesa(mesa);
                    },
                  ),
                ),
              );
                ...
                children: [
                  ...
                  Expanded(
                    child: Obx(() {
                      ...
                      List<Mesa> mesasOrdenadas = List<Mesa>.from(
                        controller.mesas,
                      );
                      mesasOrdenadas.sort((a, b) {
                      ...
                      child: Column(
                        children: [
                          TextField(
                            ...
                            onChanged: (value) =>
                                controller.nombreOrden.value = value,
                          ),
                          SizedBox(height: 16),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
